...
public class TeamResource {
	...
	@PUT
	@Path("{id}")
	public Response updateTeam(@PathParam("id") Long teamId, 
	...
	@GET
	public List<Team> searchTeamByName(@QueryParam("name") String name,
									   @BeanParam PageRequestBean pageRequestBean){
		
		List<Team> teams = service.searchTeamByName(name, pageRequestBean.getPage(), 
													pageRequestBean.getSize());
